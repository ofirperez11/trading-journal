      ...
      <form onSubmit={handleSubmit} className="card space-y-4">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <label className={`${field} sm:col-span-2`}>
            ...
            <input type="number" step="any" dir="ltr" className="input" value={form.peak} onChange={(e) => set('peak', e.target.value)} placeholder="המחיר המקסימלי שהעסקה הגיעה אליו לטובתך" />
          </label>
